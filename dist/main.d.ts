...
declare class Pressure {
     ...
     */
    constructor(value: number, unit?: PressureUnits);
    /**
     * @method toJSON
     ...
     * @returns {string}
     */
    toStringASCII(unit?: PressureUnits): string;
    /**
     ...
     * @returns {string}
     */
    toStringStandard(unit?: PressureUnits): string;
    /**
     * @method toValue
     ...
     * @returns {number}
     */
    toValue(unit?: PressureUnits): number;
}
/**
